...
const Index = () => {
  ...
  const wishes = [
    { name: "Света", message: "Бабушка, с днем рождения! Твои пирожки самые вкусные на свете! Люблю тебя! ❤️" },
    { name: "Игорь", message: "Бабуля, желаю тебе крепкого здоровья и многих лет жизни! Ты самая лучшая!" },
    { name: "Оля", message: "Спасибо за твою мудрость и заботу. С днем рождения, родная!" },
    { name: "Миша", message: "Бабушка, ты научила меня быть добрым и отзывчивым. С праздником!" }
  ];
    ...
    <div className="min-h-screen bg-[#FFF9F0]">
      ...
      <section className="relative h-[70vh] flex items-center justify-center overflow-hidden">
        <div 
          ...
          style={{ 
            backgroundImage: "url('https://images.unsplash.com/photo-1556010500-3155fd6975ea?q=80&w=1738&auto=format&fit=crop')",
        ...
        <div className="relative z-10 text-center px-4 max-w-3xl">
          ...
          <p className="text-xl md:text-2xl text-white mb-8 drop-shadow-md">
            Самой любимой и родной бабушке в мире исполняется 75 лет
          </p>
          <Button 
      ...
      <section className="py-16 px-4 md:px-8 bg-[#FEF7CD]/30">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-3xl font-bold mb-8 text-gray-800">Приглашаем на праздник</h2>
      ...
      <section className="py-16 px-4 md:px-8">
        <div className="max-w-5xl mx-auto">
          <h2 className="text-3xl font-bold mb-8 text-center text-gray-800">Счастливые моменты</h2>
          ...
          <div className="relative">
            ...
            <button 
              onClick={() => setActiveImage(prev => (prev === 0 ? photos.length - 1 : prev - 1))}
            ...
            <button
              onClick={() => setActiveImage(prev => (prev === photos.length - 1 ? 0 : prev + 1))}
      ...
      <section id="wishes" className="py-16 px-4 md:px-8 bg-[#F2FCE2]/30">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-3xl font-bold mb-8 text-center text-gray-800">Поздравления от близких</h2>
          
          <div className="grid md:grid-cols-2 gap-6">
            {wishes.map((wish, index) => (
              <Card key={index} className="bg-white/70 border-none shadow-md overflow-hidden hover:shadow-lg transition-shadow">
                <CardContent className="pt-6">
                  <div className="mb-4">
                    <div className="w-12 h-12 bg-[#FFDEE2] rounded-full flex items-center justify-center mb-2">
                      <span className="font-bold text-lg">{wish.name.charAt(0)}</span>
                    </div>
